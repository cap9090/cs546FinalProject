...
updateCustomer = (id, newCustomerData) => {
  ...
  return getCustomerByNodeUUID(id).then((customer) => {
    ...
    if (newCustomerData.profile.zipCode !== undefined && typeof parseInt(newCustomerData.profile.zipCode) === 'number') {
      updatedCustomer.profile.zipCode = parseInt(xss(newCustomerData.profile.zipCode));
    }
    if (newCustomerData.profile.monthlyIncome !== undefined && typeof parseInt(newCustomerData.profile.monthlyIncome) === 'number') {
      updatedCustomer.profile.monthlyIncome = parseInt(xss(newCustomerData.profile.monthlyIncome));
    }
